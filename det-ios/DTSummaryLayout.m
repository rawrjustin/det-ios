...
@interface DTSummaryLayout ()

@property (nonatomic, strong) NSDictionary *layoutInfo;

@end

// Summary Block Key for layoutInfo Dictionary
static NSString * const kDTSummaryBlockCell = @"SummaryBlock";

@implementation DTSummaryLayout
...
- (void)setup {
    self.itemInsets = UIEdgeInsetsMake(20.0f, 12.0f, 8.0f, 12.0f);
...
- (void)prepareLayout {
    ...
    newLayoutInfo[kDTSummaryBlockCell] = cellLayoutInfo;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    return self.layoutInfo[kDTSummaryBlockCell][indexPath];
}
